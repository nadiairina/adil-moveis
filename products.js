const window_products = {
  ...
  "sofas-9": {
    ...
    "url": "salas.html",
    "category": "Salas",
    "description": "Com um design sofisticado, mas despretensioso, este modelo adapta-se facilmente a qualquer decoração, contribuindo para a criação de um espaço mais acolhedor e cómodo. Revestimento em tecido personalizável.",
    "custom1_name": "Dimensões",
    "custom1_options": "Standard[+0.00]|Personalizado (sob consulta)[+0.00]",
    "custom2_name": "Tecido / Cor",
    "custom2_options": "Ver Catálogo na Loja[+0.00]",
  ...
  "quartos-81": {
    "id": "quartos-81",
    "name": "Sommier Articulado Estofado",
    "price": 0,
    "url": "quartos.html",
    "category": "Quartos",
